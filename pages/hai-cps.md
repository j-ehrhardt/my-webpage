...
For a deeper insight into HAI-CPS, check out our papers on the [benchmark](https://jonas-ehrhardt.de/an-ai-benchmark-for-diagnosis-reconfiguration-and-planning/) itself and on [Design Principles for Falsifiable, Replicable, Reproducible Empirical Machine Learning Research](https://jonas-ehrhardt.de/design-principles-for-falsifiable-replicable-and-reproducible-empirical-machine-learning-research/).
